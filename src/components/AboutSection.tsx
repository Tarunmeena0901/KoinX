            ...
            <div className="m-5 ml-10 mb-10 flex flex-col gap-y-5">
                ...
                <div className="flex flex-col gap-y-3 divide-y">
                    <div>
                        ...
                        <p className="line-clam-6 text-lg font-medium text-slate-700 text-wrap">
                    ...
                    <div className="flex flex-col gap-y-5">
                        ...
                        <div className="flex flex-col gap-y-5">
                            <Typography style={{ fontSize: "34px", fontWeight: "bold", color: "black" }}>Already Holding Bitcoin ?</Typography>
                            <div className="grid grid-cols-2 gap-x-10 h-[15rem] mr-7">
                                <div className="flex items-center bg-gradient-to-br from-emerald-300 to-indigo-600 rounded-lg ">
                                    <div className="ml-5 flex items-center col-span-1 gap-x-10 p-5">
                                        <img
                                            className="w-[10rem] h-[10rem] object-cover mr-4 rounded-lg"
                                            src={"https://4kwallpapers.com/images/walls/thumbs_2t/13812.png"}
                                            alt="Box Image"
                                        />
                                        <div className="flex flex-col col-span-1 justify-center gap-y-3">
                                            <div className="w-[12rem]">
                                                <Typography style={{ fontSize: "26px", fontWeight: "bold", color: "white" }}>Calculate Your Profits</Typography>
                                            </div>
                                            <div className="bg-white rounded-lg h-[3rem] flex items-center justify-center gap-x-3">
